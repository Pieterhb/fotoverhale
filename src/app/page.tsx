  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 space-y-12 sm:space-y-16">
      ...
      <section className="relative overflow-hidden rounded-2xl bg-gradient-to-b from-panel via-charcoal to-graphite border border-panel-border p-6 sm:p-12 shadow-2xl">
        ...
        {/* Subtle decorative pulp watermark / background accent */}
        <div className="absolute -right-10 -bottom-10 opacity-5 pointer-events-none select-none">
          <span className="font-heading text-[180px] font-black text-paper">FV</span>
        </div>

        <div className="relative z-10 max-w-4xl space-y-6">
          
          <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-pulp-amber/10 border border-pulp-amber/30 text-pulp-amber text-xs font-semibold uppercase tracking-wider">
            <Sparkles className="w-3.5 h-3.5" />
            <span>Suid-Afrikaanse Kultuurskatte & Africana Argief</span>
          </div>

          <h1 className="font-heading text-4xl sm:text-6xl lg:text-7xl font-bold text-paper uppercase tracking-tight leading-none">
          ...
          <p className="text-base sm:text-xl text-slate-muted font-normal max-w-2xl leading-relaxed">
          ...
          {/* Quick Stats Grid */}
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 pt-4 border-t border-panel-border/80">
            
            <div className="bg-graphite/60 border border-panel-border rounded-lg p-3.5">
        ...
        {spotlightSeries.length > 0 && (
          <div className="hidden lg:grid grid-cols-4 gap-3 mt-8 pt-8 border-t border-panel-border">
            <div className="col-span-4 text-xs font-heading uppercase text-pulp-amber tracking-widest mb-1">
